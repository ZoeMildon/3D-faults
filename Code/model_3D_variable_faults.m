    ...
    if isempty(constant_dip)==1
        ...
        if isempty(rake)==1
            ...
            if constant_dip~=90 && isempty(proj_dir)==1
                ...
                %clearvars x_points y_points z_points delta_x delta_y delta_z grid_size_depth grid_size_surface fault_down_dip_length flength grid_size_to_depth slip_distribution
