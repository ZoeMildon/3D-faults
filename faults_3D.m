...
grid_size=1;      % Units in kilometres, the size of the rectangular elements along strike

fault_slip_name='Paganica';   % The name of the fault that slips

filename='Paganica_example'      % Name of the outputfile that will be created

UTM_zone=33; % Specify the UTM zone and letter of the region
UTM_letter='T';

%%%%%%%     DEFINING THE LIMITS OF THE GRID (UTM coordinates)
min_x=285; 
max_x=475; 
min_y=4570; 
max_y=4810; 
...
%                           Change to distance (in km) from the north/west end to control the location of maximum slip along the fault.
%                           This must be less than length of the fault that
%                           ruptures.
centre_vertical=0;      % 0=default center of the fault. 
%                           Change to distance (in km) from the surface to control the location of maximum slip down-dip of the fault.
%                           This must be less than the rupture depth.

%%%%%%%     LOCATION OF DATA FILES      %%%%%%%%%%%%%%

% The format of all data files must be "fault_name  data". See examples provided.
